...
namespace ScriptStack.Runtime
{
    ...
    public class Interpreter
    {
        ...
        /// <summary>
        /// Convert a runtime value to a boolean using "truthy" semantics.
        ///
        /// This prevents runtime InvalidCastException when conditions are based on
        /// integers (e.g. result of bitwise operations).
        /// </summary>
        private static bool IsTruthy(object value)
        {
            ...
            // Fallback: any other object is considered "true".
            return true;
        ...
        private void Logic()
        {
            ...
            bool dstVal = IsTruthy(dst);

            bool srcVal = IsTruthy(src);
        ...
        private void JZ()
        {
            ...
            if (!IsTruthy(Evaluate(instruction.First)))
                return;
